...
SECRET_KEY = 'sx%-$t8=_zaak*8e_b5nsg(u%&8zi&rx622j*w59rg4(s9hog1'

# Add your site's domain name(s) here.
ALLOWED_HOSTS = ['www.iddpmirichmond.com']
...
DEFAULT_FROM_EMAIL = 'IDDPMI Richmond CA <info@iddpmirichmond.com>'

# A list of people who get error notifications.
ADMINS = [
    ('Administrator', 'admin@iddpmirichmond.com'),
]
